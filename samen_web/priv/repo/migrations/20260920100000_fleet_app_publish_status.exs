defmodule Samen.WebTest.Repo.Migrations.FleetAppPublishStatus do
  @moduledoc """
  T166 / ADR-050 §4.1 — `wfa_publish_status`: the per-app OPT-IN to the PUBLIC
  status page, added to the samen_web test-support mount of the fleet blueprint
  (`test/support/fleet.ex`).
  ...
  @resources [Samen.WebTest.Fleet.App]

  def up do
    alter table(:wfa_app) do
      add(:wfa_publish_status, :boolean, null: false, default: false)
    end
