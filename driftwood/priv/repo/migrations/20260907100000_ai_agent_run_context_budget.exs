defmodule Driftwood.Repo.Migrations.AiAgentRunContextBudget do
  @moduledoc """
  ADR-048 §6 (`T218`, batch C2) — the driftwood mount of one additive column on the
  already-catalogued `ai_agent_run` table (the samen_core-owned `Samen.AI.Agent.Run`
  resource rides this host's repo). Replicates
  `samen_core/priv/test_repo/migrations/20260907100000_ai_agent_run_context_budget.exs`
  verbatim:
